...
export const uz: Record<TranslationKey, string> = {
  ...
  'howItWorks.step2.title': 'Onlayn to\'lang',
  ...
  'categories.experiences': 'Tajribalar',
  ...
  'pricing.basic.f1': '3 tagacha faol sertifikat',
  'pricing.basic.f2': 'Hamkor kabineti',
  'pricing.basic.f3': 'Asosiy tahlil',
  'pricing.basic.f4': 'Katalogda joylashtirish',
  'pricing.pro.f1': '10 tagacha sertifikat',
  'pricing.pro.f2': 'Tavsiyalarda ko\'rsatish',
  'pricing.pro.f3': 'Sertifikatlarni yuqoriga chiqarish',
  'pricing.pro.f4': 'Kengaytirilgan tahlil',
  'pricing.pro.f5': 'Ustuvor qo\'llab-quvvatlash',
  'pricing.pro.f6': 'Katalogda joylashtirish',
  'pricing.pro.f7': 'Hamkor kabineti',
