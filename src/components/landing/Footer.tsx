import { Gift, Instagram, Send, Phone } from 'lucide-react'
          ...
          <div id="contact">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  onClick={() => track('footer_telegram_clicked')}
                  className="inline-flex items-center gap-2.5 text-gray-400 hover:text-white transition-colors"
                >
              ...
              <li>
                <a
                  href="https://www.instagram.com/happybox.sovga/"
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => track('footer_instagram_clicked')}
                  className="inline-flex items-center gap-2.5 text-gray-400 hover:text-white transition-colors"
                >
              ...
              <li>
                <a
                  ...
                  onClick={() => track('footer_phone_clicked')}
                  className="inline-flex items-center gap-2.5 text-gray-400 hover:text-white transition-colors"
                >
            ...
            <div className="mt-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-4 py-2.5 rounded-xl transition-colors text-sm"
              >
